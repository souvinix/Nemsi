...
public interface GameSettings {
    ...
    int maxCardsPerHand = 8; //Maximal Kartenanzahl pro Hand
    int maxFieldcards = 7; //Maximale Kartenanzahl auf dem Spielfeld
    ...
    int numberFontSize = 50; //Die Visualisierung der Anzahl der Deck- oder Friedhofskarten
    ...
    Color color_numberVisualization = new Color(1f, 1f, 1f, 0.5f);
