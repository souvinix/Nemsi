...
public class All_Cards{
    ...
    public static Card[] fire_cards = {
            ...
            new Card("Garodon", 300, 500, Element.FIRE, new Effect("Zerstöre 2 Eis-Karten.", EffectModule.DESTROY_N, 2, Element.ICE)),
    ...
    public static Card[] wind_cards = {
            ...
            new Card("Sensei", 300, 300, Element.WIND, new Effect("Zerstöre 2 Wind-Karten", EffectModule.DESTROY_N, 2, Element.WIND)),
    ...
    public static Card[] nature_cards = {
            new Card("Baum der Weisen", 20, 420, Element.NATURE, new Effect("Heile dich um 300", EffectModule.HEAL_HERO, 300)),
            new Card("Der Gefallene", 70, 200, Element.NATURE, new Effect("Ziehe eine Wind-Karte.", EffectModule.DRAW_N, 1, Element.WIND)),
            new Card("Blattklinge", 250, 600, Element.NATURE, new Effect("Heile dich um 200.", EffectModule.HEAL_HERO, 200)),
            new Card("Laub-Diener", 10, 40, Element.NATURE, new Effect("Ziehe eine Karte.", EffectModule.DRAW_N, 1)),
            new Card("Eichkaiser", 100, 1000, Element.NATURE, new Effect("Heile dich um 1000.", EffectModule.HEAL_HERO, 1000))
    };
    ...
    public static Card[] antimatter_cards = {
            ...
            new Card("Dunkler Lord", 800, 500, Element.ANTIMATTER, new Effect("Zerstöre 2 Feuer-Karten.", EffectModule.DESTROY_N, 2, Element.FIRE)),
            new Card("NEMESIS", 1400, 2000, Element.ANTIMATTER, new Effect("Zerstöre alle anderen Antimaterie-Karten", EffectModule.DESTROY_ALL_OTHER, 0, Element.ANTIMATTER))
    };
    ...
    public static Card[] ice_cards = {
            ...
            new Card("Wächterin Eris", 100, 800, Element.ICE, new Effect("Heile eine Karte um 800.", EffectModule.HEAL_N, 800)),
            new Card("Gefallener Drache", 700, 1200, Element.ICE, new Effect("Heile eine Wind-Karte um 1500.", EffectModule.HEAL_N, 1500, Element.WIND)),
            new Card("Königin Emilia", 1000, 1500, Element.ICE, new Effect("Heile alle verbündeten Karten um 1000.", EffectModule.HEAL_TEAM, 1000))
    };
